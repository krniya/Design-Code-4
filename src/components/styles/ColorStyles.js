export const themes = {
    ...
    dark: {
        ...
        card: {
            ...
            boxShadow: "0px 30px 60px rgba(0, 0, 0, 0.25), inset 0 0 0 0.5px rgba(255, 255, 255, 0.2)",
        ...
        modal: {
            ...
            boxShadow: "0px 50px 100px rgba(0, 0, 0, 0.25), inset 0 0 0 0.5px rgba(255, 255, 255, 0.3)",
            backgroundColorFull: "rgba(15,14,71,1)"
        }
    }
}